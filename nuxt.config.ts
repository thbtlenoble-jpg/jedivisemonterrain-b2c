...
const config: NuxtConfig = {
  ...
  fontawesome: {
    ...
    suffix: true,
    icons: {
      // UNIQUEMENT des icônes qui existent dans @fortawesome/free-solid-svg-icons
      solid: [
        'faCheck',        // ✓ coche
        'faBars',         // ☰ menu hamburger
        'faTimes',        // ✕ fermer
        'faRedo',         // ↺ rejouer vidéo
        'faThumbsUp',     // 👍 confirmation
        'faChevronRight', // > flèche droite
        'faChevronLeft',  // < flèche gauche
        'faMapMarkerAlt', // 📍 marqueur carte
        'faSpinner',      // ⟳ chargement (remplace spinner-third pro)
        'faUpload',       // ↑ upload fichiers
      ],
      // Icônes free-regular
      regular: [
        'faCheck',
